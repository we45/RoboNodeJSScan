...
class RoboNodeJSScan(object):
    ...
    def run_nodejsscan_against_source(self, code_path, results_path):
        ...
        self.client.containers.run(
            self.nodejsscan_docker, mounts=[source_mount, results_mount]
        )
        logger.info(
            "Successfully ran NodeJSScan against the src. Please find the *.html and *.json files in the results directory"
        )
